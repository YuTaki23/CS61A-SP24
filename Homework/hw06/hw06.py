...
class VendingMachine:
    ...
    def vend(self):
        ...
        if self.current_fund < self.price:
            return f"Please add ${self.price - self.current_fund} more funds."
        change = self.current_fund - self.price
        self.current_fund = 0
    ...
    def add_funds(self, fund):
        ...
        return f"Current balance: ${self.current_fund}"
    
    def restock(self, stock):
        self.current_stock += stock
        return f"Current {self.product} stock: {self.current_stock}"
